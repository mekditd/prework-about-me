...
$("#factButton").on("click", function() {
	// We generate a random number between 0 and 4 (the number of facts in the carFactArray)
	var number = Math.floor((Math.random() * booFacts.length));
	//
	$("#factText").text(booFacts[number])
})

// corrected missing quotation marks in booFacts Array 
...
// corrected mssing quotation mark for click
